...
- ACL Python service principal (`AzureClientId`): [ResourceProvisionerPythonServicePrincipal.md](/DeveloperGuide/Security/ResourceProvisionerPythonServicePrincipal.md)
