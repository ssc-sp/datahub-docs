[_metadata_: remarks]:- "Automatically translated with DeepL. From: /DataHub-Opendata-Publishing-API.md"

[_(draft documentation, please review)_](/DataHub-Opendata-Publishing-API.md)
