[_metadata_: remarks]:- "Automatically translated with DeepL. From: /Use-AzCopy-to-Interact-with-Azure-Storage-Account.md"

[_(draft documentation, please review)_](/Use-AzCopy-to-Interact-with-Azure-Storage-Account.md)
