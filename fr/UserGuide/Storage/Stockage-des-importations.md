...
3. Les identifiants de connexion sont spécifiques à chaque fournisseur de services en nuage. Pour plus de détails, veuillez consulter les pages suivantes :
    - [Importation du stockage Azure](Importer-le-stockage-Azure.md)
    - [Importation du stockage AWS](Importer-le-stockage-AWS.md)
    - [Importation du stockage Google Cloud Platform](Importer-le-stockage-GCP.md)
